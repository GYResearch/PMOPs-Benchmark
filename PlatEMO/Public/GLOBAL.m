...
%--------------------------------------------------------------------------
   ...
   %% control the knee functions
    properties
        A          = 4;               % control the number of knees, and width of knee region of PMOP
    end
    properties
    ...
    properties
        Knee          = 4;               % Number of Knee regions
    end
    properties
        l          =  12;               % Shape of Knee regions
    end
    properties
        S          = 4;               % Shape of Knee regions
    end
    properties
