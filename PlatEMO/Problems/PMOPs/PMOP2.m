...
methods
    %% Initialization    
        function obj = PMOP2()
            ...
            obj.Global.S = 2; % control the depth of knee
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            if  Linkage ~= 0   %% l2 linkage function in g1
                temp2 = zeros(N,D-M+1);
                for i=1:D-M+1
                   temp2(:,i) =  (1+ cos(0.5.*pi.*i./(D-M+1))).*(PopDec(:,M-1+i) - obj.Global.lower(M-1+i)) - PopDec(:,1).*(obj.Global.upper(M-1+i) - obj.Global.lower(M-1+i));   
                end  
                temp2 = temp2.^2;
                g = sum(temp2,2); %% g2...       
            end
